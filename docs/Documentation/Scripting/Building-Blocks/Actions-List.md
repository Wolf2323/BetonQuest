...
and `ignoreActions` to bypass action logic, so other plugins will not be able to interfere.
...
!!! example
    ...
    itemdurability CHEST SUBTRACT %randomnumber.whole.15~30% ignoreUnbreakable ignoreActions
    ```
