...
public class ConditionPlaceholder implements PlayerPlaceholder {
     ...
     */
    public ConditionPlaceholder(final PluginMessage pluginMessage, final Argument<ConditionID> conditionId, final boolean papiMode, final QuestTypeApi questTypeApi) {
