...
public class SimpleConvIOFactory implements ConversationIOFactory {
     ...
     */
    public SimpleConvIOFactory(final BetonQuestLogger log, final ConfigAccessor config, final Plugin plugin,
    ...
    public ConversationIO parse(final Conversation conversation, final OnlineProfile onlineProfile) {
        return new SimpleConvIO(log, config, plugin, message, conversation, onlineProfile, colors);
    }
}
