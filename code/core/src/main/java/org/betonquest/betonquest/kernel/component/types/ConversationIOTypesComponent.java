...
public class ConversationIOTypesComponent extends AbstractCoreComponent {
    ...
    protected void load(final DependencyProvider dependencyProvider) {
        ...
        conversationIORegistry.register("simple", new SimpleConvIOFactory(
                loggerFactory.create(SimpleConvIOFactory.class), config, plugin, pluginMessage, colors));
        conversationIORegistry.register("tellraw", new TellrawConvIOFactory(
                loggerFactory.create(TellrawConvIOFactory.class), config, plugin, pluginMessage, colors));
        ...
        conversationIORegistry.register("slowtellraw", new SlowTellrawConvIOFactory(
                loggerFactory.create(SlowTellrawConvIOFactory.class), config, plugin, pluginMessage, fontRegistry, colors));
    }
}
