...
public class GlobalTagPlaceholder extends AbstractTagPlaceholder<GlobalData> implements PlayerlessPlaceholder {
     ...
     */
    public GlobalTagPlaceholder(final PluginMessage pluginMessage, final GlobalData data, final String tagName, final QuestPackage questPackage, final boolean papiMode) {
