...
public class MenuConvIOFactory implements ConversationIOFactory {
     ...
     */
    public MenuConvIOFactory(final BetonQuestLogger log, final ConfigAccessor config, final Plugin plugin,
    ...
    public ConversationIO parse(final Conversation conversation, final OnlineProfile onlineProfile) throws QuestException {
        ...
        return new MenuConvIO(log, config, plugin, message, inputFunction, conversation, onlineProfile, colors, settings,
