...
public abstract class AbstractTagPlaceholder<T> {
     ...
     */
    public AbstractTagPlaceholder(final PluginMessage pluginMessage, final T data, final String tagName, final QuestPackage questPackage, final boolean papiMode) {
