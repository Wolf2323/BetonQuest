...
public class TagPlaceholder extends AbstractTagPlaceholder<PlayerDataStorage> implements PlayerPlaceholder {
     ...
     */
    public TagPlaceholder(final PluginMessage pluginMessage, final PlayerDataStorage data, final String tagName, final QuestPackage questPackage, final boolean papiMode) {
