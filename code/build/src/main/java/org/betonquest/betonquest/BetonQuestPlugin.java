...
public class BetonQuestPlugin extends BetonQuest {
    ...
    public void onEnable() {
        ...
        BundledCompatibility.registerCompatiblePlugins(getLoggerFactory(), getLoggerFactory().create(BundledCompatibility.class),
                compatibility, getBetonQuestApi().instructions(), getBetonQuestApi().identifiers(), getComponentLoader().get(GlobalData.class), getCoreQuestTypeHandler().getPlaceholderProcessor(), this);
        compatibility.init();
