...
public class RPGMenuCommand extends SimpleCommand {
    ...
    public boolean simpleCommand(final CommandSender sender, final String alias, final String[] args) {
        ...
        switch (args[0].toLowerCase(Locale.ROOT)) {
            case "l":
            case "list":
                final net.kyori.adventure.text.TextComponent.Builder text = Component.text();
                text.append(getMessage(sender, "command_list"));
            ...
            case "reload":
                ...
                if (sender instanceof Player) {
                    ...
                    sendMessage(sender, "command_reload_successful",
                            ...
                            new PluginMessage.Replacement("amount", Component.text(String.valueOf(info.getLoaded()))));
                }
        }
        return true;
    }
    ...
    private void showHelp(final CommandSender sender) {
        final net.kyori.adventure.text.TextComponent.Builder text = Component.text();
        text
                .append(Component.text("----- RPGMenu for Betonquest -----\n"))
                .append(Component.text("/rpgmenu reload [menu]\n").color(NamedTextColor.RED)
                ...
                .append(Component.text("/rpgmenu list\n")
